...
function displayImages() {
  ...
  var toggle_all_checkbox = '<table margin-top="50px"><tr><td><input type="checkbox" id="toggle_all_checkbox" /></td>';
  var toggle_all_checkbox_label = '<td><label for="toggle_all_checkbox">' + visibleImages.length + '</label></td></tr></table><div></div>';
  ...
  for (var i in visibleImages) {
    ...
    images_table.append(
      '<tr><image src="line.png" >\
        ...
        <td valign="top">\
          <label for="checkbox' + i + '"><img src="' + visibleImages[i] + '" /></label>\
        </td>\
      </tr>'
    );
  }
